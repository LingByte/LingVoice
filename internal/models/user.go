...
func NewUserResponse(u *User, prof *UserProfile) UserResponse {
	if u == nil {
		return UserResponse{}
	}
...
func BuildLoginResponse(db *gorm.DB, u *User) (*LoginResponse, error) {
	if u == nil {
		return nil, errors.New("nil user")
	}
	prof, err := EnsureUserProfile(db, u.ID)
	if err != nil {
		return nil, err
	}
