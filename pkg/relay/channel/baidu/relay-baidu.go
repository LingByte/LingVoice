...
import (
	...
	helper2 "github.com/LingByte/LingVoice/pkg/relay/helper"
...
func baiduStreamHandler(c context.Context, info *common.RelayInfo, resp *http.Response, w http.ResponseWriter) (*types.NewAPIError, *dto.Usage) {
	usage := &dto.Usage{}
...
func baiduHandler(c context.Context, info *common.RelayInfo, resp *http.Response, w http.ResponseWriter) (*types.NewAPIError, *dto.Usage) {
...
func baiduEmbeddingHandler(c context.Context, info *common.RelayInfo, resp *http.Response, w http.ResponseWriter) (*types.NewAPIError, *dto.Usage) {
