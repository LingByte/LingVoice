...
func openAIChatToOllamaChat(c context.Context, r *dto.GeneralOpenAIRequest) (*OllamaChatRequest, error) {
		...
		if m.IsStringContent() {
			...
			for _, part := range parts {
				if part.Type == dto.ContentTypeImageURL {
					...
					if source != nil {
						base64Data, _, err := service.GetBase64Data(source.GetRawData(), "fetch image for ollama chat")
						if err != nil {
							return nil, err
						}
						if base64Data != "" {
...
func openAIToGenerate(c context.Context, r *dto.GeneralOpenAIRequest) (*OllamaGenerateRequest, error) {
...
func ollamaEmbeddingHandler(c context.Context, info *common.RelayInfo, resp *http.Response, w http.ResponseWriter) (*dto.Usage, *types.NewAPIError) {
