...
func (o *AliOutput) ChoicesToOpenAIImageDate(c context.Context, responseFormat string) []dto.ImageData {
				...
				if content.Image != "" {
					if strings.HasPrefix(content.Image, "http") {
						...
						if responseFormat == "b64_json" {
							...
							if err != nil {
								// logger.LogError: "get_image_data_failed: "+err.Error())
								continue
							}
							b64Json = b64
						}
...
func (o *AliOutput) ResultToOpenAIImageDate(c context.Context, responseFormat string) []dto.ImageData {
	var imageData []dto.ImageData
