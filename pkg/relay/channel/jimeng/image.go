...
func responseJimeng2OpenAIImage(_ context.Context, response *ImageResponse, info *common.RelayInfo) *dto.ImageResponse {
...
func jimengImageHandler(c context.Context, resp *http.Response, info *common.RelayInfo, w http.ResponseWriter) (*dto.Usage, *types.NewAPIError) {
