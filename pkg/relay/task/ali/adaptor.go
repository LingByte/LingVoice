...
func (a *TaskAdaptor) BuildRequestBody(c context.Context, info *common.RelayInfo) (io.Reader, error) {
	taskReq, err := common.GetTaskRequest(c)
	if err != nil {
...
func firstTaskImage(req common.TaskSubmitReq) string {
...
func secondTaskImage(req common.TaskSubmitReq) string {
	nonEmptyImages := 0
	for _, image := range req.Images {
...
func normalizeWan27I2VInput(aliReq *AliVideoRequest, req common.TaskSubmitReq) error {
...
func (a *TaskAdaptor) convertToAliRequest(info *common.RelayInfo, req common.TaskSubmitReq) (*AliVideoRequest, error) {
	...
	if req.Metadata != nil {
		if metadataBytes, err := json.Marshal(req.Metadata); err == nil {
			err = json.Unmarshal(metadataBytes, aliReq)
			if err != nil {
...
func (a *TaskAdaptor) DoResponse(c context.Context, resp *http.Response, info *common.RelayInfo) (taskID string, taskData []byte, taskErr *common.TaskError) {
	...
	if err := json.Unmarshal(responseBody, &aliResp); err != nil {
...
func (a *TaskAdaptor) ConvertToOpenAIVideo(task *taskmodel.Task) ([]byte, error) {
	var aliResp AliVideoResponse
	if err := json.Unmarshal(task.Data, &aliResp); err != nil {
