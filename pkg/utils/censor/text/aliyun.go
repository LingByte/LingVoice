...
func NewAliyunTextCensor() (*AliyunTextCensor, error) {
	accessKeyID := base.GetEnv("ALIYUN_CENSOR_ACCESS_KEY_ID")
	accessKeySecret := base.GetEnv("ALIYUN_CENSOR_ACCESS_KEY_SECRET")
	endpoint := base.GetEnv("ALIYUN_CENSOR_GREEN_ENDPOINT")
