// Package synthesizer implements the Azure Cognitive Services TTS adapter for ling-base.
package synthesizer
...
func (c *AzureConfig) GetProvider() base.Provider {
	return base.ProviderAzure
}

// AzureService Azure TTS 服务
...
// 编译期保证 AzureService 实现了 base.Engine 接口
var _ base.Engine = (*AzureService)(nil)
...
func (as *AzureService) Provider() base.Provider {
	return base.ProviderAzure
}

func (as *AzureService) Format() base.StreamFormat {
	as.mu.Lock()
	defer as.mu.Unlock()
...
func (as *AzureService) Synthesize(ctx context.Context, handler base.Handler, text string) error {
	as.mu.Lock()
	opt := as.opt
	as.mu.Unlock()
