// Package synthesizer implements the Minimax T2A v2 WebSocket adapter for ling-base.
package synthesizer
...
func (c *MinimaxOption) GetProvider() base.Provider {
	return base.ProviderMinimax
}
...
func (ms *MinimaxService) Provider() base.Provider {
	return base.ProviderMinimax
}

func (ms *MinimaxService) Format() base.StreamFormat {
...
func (ms *MinimaxService) Synthesize(ctx context.Context, handler base.Handler, text string) error {
	ms.startAt = time.Now()
...
func (ms *MinimaxService) continueTask(ws *websocket.Conn, text string, handler base.Handler) error {
...
// Compile-time guard ensuring MinimaxService implements base.Engine.
var _ base.Engine = (*MinimaxService)(nil)
